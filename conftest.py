...
def browser(request):
    ...
    if request.param == 'firefox':
        ...
        driver = BROWSERS[request.param](executable_path="/usr/local/bin/geckodriver", options=options)
        ...
        options.add_argument("--start-maximized")
        options.add_argument("--headless")
        driver = BROWSERS[request.param](executable_path="/usr/local/bin/chromedriver", options=options)
        request.addfinalizer(lambda *args: driver.quit())
        return driver